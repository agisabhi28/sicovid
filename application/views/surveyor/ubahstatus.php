        ...
        <div class="col-md-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Accepted</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="status_cek">Status </label>
                            <select class="form-control" id="status_cek" name="status_cek" readonly>
                        ...
                        <a href="<?= base_url('surveyor'); ?>" class="btn btn-danger">Kembali</a>
                        <button type="submit" name="tambah" class="btn btn-primary float-right">Verifikasi Data </button>
